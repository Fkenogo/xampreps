 ...
 * 
 * Usage: node scripts/import-kcpe-mathematics-2023.js
 */
...
} = require('../src/integrations/firebase/v2-collections');

// Import the import package
const importPackage = JSON.parse(
  fs.readFileSync(path.join(__dirname, '../docs/data/kcpe-mathematics-2023-kenya-v2-import.json'), 'utf8')
);

// Import answer key for explanations
const answerKey = fs.readFileSync(path.join(__dirname, '../docs/data/kcpe-mathematics-2023-kenya-answer-key.md'), 'utf8');
...
module.exports = KCPEImportScript;